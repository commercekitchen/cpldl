...
export function CourseErrorPage() {
  ...
  let title = 'Course failed to load';
  let message = 'Something went wrong while loading this course.';
  ...
  if (isRouteErrorResponse(error)) {
    ...
    if (status === 404) {
      ...
      message = 'This course may have been removed or the link is incorrect.';
      severity = 'warning';
      ...
      title = `Unable to load course (${status})`;
