...
RSpec.describe LibraryLocation, type: :model do
  ...
  it "should sort by sort order by default" do
    last_branch = FactoryGirl.create(:library_location, sort_order: 10, created_at: 10.days.ago)
    first_branch = FactoryGirl.create(:library_location, sort_order: 1, created_at: Time.zone.now)
