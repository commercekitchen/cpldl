...
Rails.application.configure do
  ...
  # config.active_job.queue_name_prefix = "cpl_digital_learn_#{Rails.env}"

  config.action_mailer.perform_caching = false

  config.action_mailer.default_url_options = { host: "digitallearn.org" }
  ...
  config.action_mailer.asset_host = "https://digitallearn.org"
