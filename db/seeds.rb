...
admin_profile = Profile.create(first_name: "Super", zip_code: "80206", user: admin_user)
...
admin_profile = Profile.create(first_name: "Super", zip_code: "37115", user: admin_user)
...
admin_profile = Profile.create(first_name: "Alex", zip_code: "80209", user: regular_user)
...
admin_profile = Profile.create(first_name: "Developer", zip_code: "80209", user: dev_user)
