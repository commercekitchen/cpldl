...
module Admin
  class DashboardController < BaseController
    ...
    def import_courses
      ...
      @all_subsite_ids = Course.pla.published.pluck(:id)
      @previously_imported_ids = current_organization.courses.where.not(publication_status: :archived).pluck(:parent_id).compact
